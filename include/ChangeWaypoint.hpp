...
#include <std_msgs/msg/int32.hpp>  // برای leader id و wp_idx
...
private:
    ...
    rclcpp::Publisher<std_msgs::msg::Int32>::SharedPtr waypoint_idx_pub;  // برای انتشار wp_idx
    rclcpp::Subscription<std_msgs::msg::Int32>::SharedPtr waypoint_idx_sub;  // برای دریافت wp_idx
    ...
    rclcpp::Subscription<std_msgs::msg::Int32>::SharedPtr leader_subscriber;
};